#script para convertir un hash hexadecimal a binario
#para tener mas precision en el proof of work
...
def hex_to_binary(hex_string):
    ...
    for character in hex_string:
        binary_string += HEX_TO_BINARY_CONVERTION_TABLE[character]

    return binary_string

def main():
    number=451
    hex_number=hex(number)[2:] #se hace una subcadena cortando el "0x" que no es necesario
